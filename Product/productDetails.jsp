                    ...
                    <div class="col-lg-12">
						...
						<div class="row" >
							<div class="col-sm-6">
								...
								<h4>Selling Price(per item) :<c:out value="${requestScope.Product.sellingPrice}"/> </h4>
						...
						<a href="${initParam.baseurl}/productedit?id=${requestScope.Product.id}">Edit</a> | <a href="${initParam.baseurl}/product">Back To List</a>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
