                    ...
                    <div class="col-lg-12">
						...
						<div class="row" id="category">
							<div class="col-sm-6">
								<form method="post">
									<h4>Name</h4>
									<input type="text" name="name" value="${param.name}" class="form-control" placeholder="Supplier Name"/>
									<h4>Contact</h4>
									<input type="text" name="contact" value="${param.contact}" class="form-control" placeholder="Contact"/><br/>
